    ...
    this.ctx.container.innerHTML = `
      <div class="header">
        ...
        return `
          ...
          <span class="developer-name"><span class="dev-prefix">DEV</span>rjay7642</span>
          <a href="https://github.com/rjay7642/world-monitoring-system-" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
